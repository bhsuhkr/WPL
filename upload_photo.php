            ...
            <div class="row">
              <div class="col-md-6">
                  <div class="form-group">
                      <input type="text" id="category" name="category" class="form-control" placeholder="Category *" value="" />
                  </div>

                  <div class="form-group">
                      <input type="text" id="selectedUserID" name="selectedUserID" class="form-control" placeholder="User ID *" value="" />
                  </div>
                  ...
                  <div class="form-group">
                      <textarea id="description" name="description" class="form-control" placeholder="Description" style="width: 100%; height: 150px;"></textarea>
                  </div>
